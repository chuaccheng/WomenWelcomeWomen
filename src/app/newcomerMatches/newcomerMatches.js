class NewcomerMatchesController {
  /** @ngInject */
  constructor($http, $scope) {
    ...
    this.matches = [ {newcomer: {fullName: 'Cheng Chua', country: 'Singapore'}, interest: {id: 'food_shopping', name: 'Food shopping', selected: false}},
                     {newcomer: {fullName: 'Jennifer Fein', country: 'United States'}, interest: {id: 'english', name: 'English language practice', selected: false}},
                     {newcomer: {fullName: 'Eva Plasencia', country: 'Plasencia'}, interest: {id: 'prof_mentor', name: 'Professional mentorship', selected: false}},
...
export const newcomerMatches = {
  templateUrl: 'app/newcomerMatches/newcomerMatches.html',
  controller: NewcomerMatchesController
};
